...
/**
 ...
 @note In terms of the Grand Central Dispatch calls made behind the scenes, this method
   calls `dispatch_suspend(...)` on the `dispatch_source_t` object upon which `RACDispatchTimer` relies.
 @note The `dispatch_source_t` object isn't canceled until the `RACDispatchTimer` object deallocates.
