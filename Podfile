...
# pod 'BrynKit/SEGradientSwatch' , :path => '.'

# the podspec
# podspec :path => './BrynKit.podspec'
#


pod 'libextobjc',                   :podspec => 'https://gist.github.com/brynbellomy/6060471/raw/080e94ce257a8cd8f67b74195d9b3c05fd7b274d/libextobjc.podspec'
...
target 'BrynKitTests', :exclusive => true do
    # pod 'TestPilot'
    pod 'Kiwi'
end
