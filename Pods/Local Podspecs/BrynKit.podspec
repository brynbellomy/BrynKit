...
Pod::Spec.new do |s|
    ...
    s.requires_arc = true
    s.frameworks = 'UIKit', 'CoreGraphics', 'ImageIO', 'QuartzCore'
    ...
    s.subspec 'Main' do |subspec|
        ...
        subspec.source_files = "Main/*.{m,h}", "UIColor/*.{m,h}", "CocoaLumberjack/*.{m,h}", "EDColor/*.{m,h}"
    ...
    s.subspec 'RACHelpers' do |subspec|
        ...
        #subspec.dependency 'ReactiveCocoaLayout-HEAD'
    end
